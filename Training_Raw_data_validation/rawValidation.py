...
class Raw_Data_validation:
    ...
    def validationFileNameRaw(self, regex, LengthOfDateStampInFile, LengthOfTimeStampInFile):
        """
                    ...
                    Description: This function validates the name of the training csv files as per given in the schema!
                                 Regex pattern is used to do the validation.If name format do not match the file is
                                 moved to Bad Raw Data folder else in Good raw data.
                    Output: None
    ...
    def validateColumnLength(self, NumberofColumns):
        """
                          ...
                          Description: This function validates the number of columns in the csv files.
                                       ...
                                       If not same file is not suitable for processing and thus is moved to
                                       Bad Raw Data folder.
