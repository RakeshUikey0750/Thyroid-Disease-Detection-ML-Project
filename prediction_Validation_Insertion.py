...
from Prediction_FileToDB.combined_csv import csv_Operations
...
class pred_validation:
    ...
    def prediction_validation(self):
        ...
        try:
            ...
            self.log_writer.log(self.file_object, 'Combining all prediction files into one for database insertion')
            self.csv_Operations.combine_all_csv()
            self.log_writer.log(self.file_object, 'Combining all prediction files into one is successful')
