...
class csv_Operations:
    ...
    def __int__(self):
        self.file_object = open("Training_Logs/Combine_all_csv.txt", 'a+')
    ...
    def combine_all_csv(self):
        """
                       ...
                       Revisions: None
        """
        file_object = open("Training_Logs/Combine_all_csv.txt", 'a+')
        ...
        try:
            ...
            try:
                ...
                goodFilePath = os.chdir('Training_Raw_files_validated\\Good_Raw')
            ...
            combined_csv.to_csv("Training_FileToDB/combined_csv.csv", index=False, encoding='utf-8-sig')
